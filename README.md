...
* Execute `ruby deploy-aws.rb <domain> "<email>"`
  * Put your email address in quotes; this address is used for registering your HTTPS certificate
...
* Note: there are no backups set up.  You may want to back up the database (PostgreSQL) and uploaded images (`/home/pi/simpleblog/storage`).
